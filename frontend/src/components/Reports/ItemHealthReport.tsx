...
import { Copy, Ghost, ChevronDown, ChevronRight, RefreshCw } from 'lucide-react'
...
import { GetDuplicateItems, GetOrphanedItems, GetSelfReferentialItems, GetSettings, SaveReportItemHealthCollapsed, SaveTabSelection } from '../../../wailsjs/go/main/App'
  ...
  return (
    <Paper p="lg" withBorder>
      <Group mb="md" style={{ cursor: 'pointer' }} onClick={toggleCollapsed}>
        ...
        <div>
          <Title order={2} size="h3">Item Health</Title>
