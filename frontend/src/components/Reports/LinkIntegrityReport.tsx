...
import { GetUnlinkedReferences, GetLinkedItemsNotInDefinition, GetDanglingLinks, GetSettings, SaveReportLinkIntegrityCollapsed, SaveTabSelection } from '../../../wailsjs/go/main/App'
  ...
  return (
    <Paper p="lg" withBorder>
      <Group mb="md" style={{ cursor: 'pointer' }} onClick={toggleCollapsed}>
        ...
        <div>
          <Title order={2} size="h3">Link Integrity</Title>
