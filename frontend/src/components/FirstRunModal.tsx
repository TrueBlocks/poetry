  ...
  return (
    ...
    >
      {step === 'ask' ? (
        <Stack>
          <Text>
            This application includes AI-powered features like Text-to-Speech and automated definitions.
          </Text>
          <Text fw={500}>
            Do you wish to enable these features?
          </Text>
          <Text size="sm" c="dimmed">
            You will need an OpenAI API Key. You can change this later in Settings.
          </Text>
